...
setup(
    ...
    extras_require={
        'dev': ['check-manifest'],
        'test': ['shutilwhich', 'pep8', 'pytest', 'pytest-cov', 'coverage', 'coveralls', 'future', 'tabulate', 'sphinx', 'sphinx_bootstrap_theme', 'pygments-style-solarized', 'data-science-types', 'numpy', 'pandas'],
    },
